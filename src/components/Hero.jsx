...
export default function Hero(props) {
  return (
    <div
      className={
        props.theme
          ? "w-full hero__background hero__dark"
          : "w-full hero__background hero__light"
      }
    >
      <div className="hero__background-color w-full md:h-full">
        <div className="grid md:grid-cols-5 grid-cols-1 grid-flow-col h-full md-max:pt-16">
          <div className="col-span-3 hero__column md-max:hidden">
            <div className="text-6xl text-center hero__name sm-max:hidden md:block">
              ANDREW CHOUGH
            </div>
            ...
            <div className="text-2xl text-center sm-max:hidden hero__name">
              <p>
                ...
                <span
                  className={`${
                    props.theme ? "text-light-blue" : "text-dark-blue"
                  } underline`}
                >
                  Designer
                </span>{" "}
                ...
                <span
                  className={`${
                    props.theme ? "text-light-green" : "text-dark-green"
                  } underline`}
                >
                  Engineer
                </span>
          ...
          <div className="col-span-2 my-auto">
            <img
              className="hero__image md-max:m-auto sm-max:w-3/4 md:m-0"
