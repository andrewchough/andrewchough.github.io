...
export default function Skills () {
  return (
    <div className="grid md:grid-cols-8 items-center block__container">
      <div className="md:col-span-2 lg:col-span-2 block__header md:py-10 py-4">
        <h2 className="text-4xl font-semibold">SKILLS</h2>
      </div>
      <div className="md:col-span-3 block__section p-16 md-max:p-8 h-full">
      ...
      <div className="md:col-span-3 block__section p-16 md-max:pt-0 md-max:p-8 lh-full">
