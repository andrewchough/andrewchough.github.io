  ...
  return (
    <div className="grid md:grid-cols-8 items-center">
      ...
      <div className="md:col-span-2 block__header md:py-10 pb-4 md-max:hidden">
        <h2 className="text-4xl font-semibold block__title block__title--right">
          ABOUT
        </h2>
      </div>
      <div className="md:col-span-6 p-12 lg:px-24 lg:py-20">
        ...
        <p className="font-light text-center sm-max:text-sm pb-8 text-black">
          ...
          college in the Boston area, and am now residing in the Big Apple. Over
          the years, I&apos;ve become infatuated with music - ranging from
          hip-hop to jazz. I&apos;ve been playing the saxophone for more than
          twelve years, participating in bands such as the Wind Ensemble in high
        ...
        <p className="font-light text-center sm-max:text-sm text-black">
          ...
          sudoku, finding the best cold brew in the city, and AAPI advocacy and
          intersectional movements. At Adobe, I am involved with the Diversity
          and Inclusion council and am also a lead of the Asian Employee Network
          in the New York sites. A big passion of mine is helping the tech field
          more inclusive and would love to get more involved in any
          opportunities that support that cause.
        </p>
      </div>
    </div>
  );
